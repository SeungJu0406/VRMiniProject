...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // GetDelay a reference to the text object's textInfo
            ...
            // GetDelay the handle size for drawing the various
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // GetDelay Bottom Left and Top Right position of the current character
        ...
        void DrawBounds()
        {
            ...
            // GetDelay Bottom Left and Top Right position of each word
